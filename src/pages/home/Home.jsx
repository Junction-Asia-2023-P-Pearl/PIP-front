    ...
    <div className="h-screen w-screen">
      ...
      <div className="h-4/5 w-full border border-black">
        <div className="h-1/6 w-full flex justify-start items-center">
          <div className="bg-dark h-1/3 w-1/3 ml-5 rounded-2xl flex justify-center items-center border border-0 color-white">Patient List</div>
        </div>
          ...
          {patientInfo.map((patient, idx) => {
            return (
              <Link to={`/patient/${patient.patientId}`} key={idx} className="h-1/5 w-11/12 flex justify-start items-center mb-3 rounded-xl border-0">
                ...
                <div className="bg-lightGray h-full w-4/5 flex flex-col justify-center items-start">
